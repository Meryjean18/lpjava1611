...
public class MySqlProvinciaDAO implements IProvinciaDAO{
    ...
    final String UPDATE=  "UPDATE Provincias "
            + " SET nombre = ?"
            + " WHERE id_prov = ?";
    ...
    public void insertar(Provincia o) throws DAOException {
        ...
        try{
            ...
            if(rs.next()){
                ...
                throw new DAOException("No se puede generar el ID del provincia");
            }    
...
//            ps.setString(i++, valor);
    ...
    @Override
    public int[] cargaMasiva(List<Provincia> lista) throws DAOException {
        PreparedStatement ps = null;
        int[] res;
        try{
    ...
    @Override
    public List<Provincia> paginacion(Integer posicion, Integer registros) throws DAOException {
        PreparedStatement ps =  null;
        ResultSet rs = null;
        List<Provincia> lista = new ArrayList<>();
        try{
